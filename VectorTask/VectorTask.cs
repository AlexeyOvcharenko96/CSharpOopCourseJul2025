...
public class VectorTask
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine(vector1 + ", Размерность = " + vector1.Size);
        Console.WriteLine(vector2 + ", Размерность = " + vector2.Size);
        Console.WriteLine(vector3 + ", Размерность = " + vector3.Size);
        Console.WriteLine(vector4 + ", Размерность = " + vector4.Size);
        Console.WriteLine(vector5 + ", Размерность = " + vector5.Size);
        Console.WriteLine();
